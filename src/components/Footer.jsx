    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a href="https://www.facebook.com/share/1H6R7p6amR/" className="social-link" aria-label="Facebook">
              ...
              <a href="https://www.linkedin.com/company/disaade/about/?viewAsMember=true" className="social-link" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} DISAADE. Tous droits réservés.</p>
          <p className="footer-made">Conçu avec passion pour sauver des vies</p>
        </div>
      </div>
    </footer>
  );
